...
// T1 - T4: OK
contract TeaMaker is Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    // V1 - V5: OK
    IUniswapV2Factory public factory;
    //0x45DE240fbE2077dd3e711299538A09854FAE9c9b
    // V1 - V5: OK
    address public bar;
    //0xd83E87B585656573e6BC7A9A93776C76e479B8d6
    // V1 - V5: OK
    ...
    modifier onlyEOA() {
        ...
        require(msg.sender == tx.origin, "TeaMaker: must use EOA");
        _;
    }
    ...
    function _convert(address token0, address token1) internal {
        ...
        require(address(pair) != address(0), "TeaMaker: Invalid pair");
        // balanceOf: S1 - S4: OK
        // transfer: X1 - X5: OK
    ...
    function _swap(
        ...
        require(address(pair) != address(0), "TeaMaker: Cannot convert");
